...
@Autonomous
public class AutoRed9BallsCloseGateYogev extends NextFTCOpMode {
...
//  Command Path9Command;
    ...
    public AutoRed9BallsCloseGateYogev(){
...
//                .build();
        ...
        Path4 = follower.pathBuilder().addPath(
                        new BezierCurve(
                                ...
                                new Pose(127.000, 52.000),
                                new Pose(154.000, 67.000),
                                new Pose(87.000, 66.000),
                                new Pose(124.000, 68.000)
                        )
                )
                .setConstantHeadingInterpolation(Math.toRadians(0))

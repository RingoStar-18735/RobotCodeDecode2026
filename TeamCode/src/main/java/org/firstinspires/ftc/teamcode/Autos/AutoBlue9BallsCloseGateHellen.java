...
@Autonomous
public class AutoBlue9BallsCloseGateHellen extends NextFTCOpMode {
    ...
    public AutoBlue9BallsCloseGateHellen(){
...
//            ShooterSubsystem.INSTANCE.StopSpeed()
    ...
    public void onInit() {
        ...
        follower.setStartingPose(new Pose(34, 135, Math.toRadians(180)));
        ...
        Path3 = follower.pathBuilder().addPath(
                        new BezierCurve(
                                new Pose(61.441, 79.749),
                                new Pose(2.132, 88.795),
                                new Pose(0.000, 79.447),
                                new Pose(40.430, 72.681),
                                new Pose(15.419, 74.754)
                        )
                )
                .setConstantHeadingInterpolation(Math.toRadians(180))
        ...
        Path5 = follower.pathBuilder().addPath(
                        new BezierCurve(
                                new Pose(65.126, 78.219),
                                new Pose(47.265, 55.634),
                                new Pose(34.319, 59.009),
                                new Pose(6.272, 55.077),
                                new Pose(0.160, 55.382),
                                new Pose(32.180, 67.859),
                                new Pose(15.625, 74.972)
                        )
                )
                .setConstantHeadingInterpolation(Math.toRadians(180))
...
//        Path11Command = new FollowPath(Path11);
    ...
    public void onStartButtonPressed() {
        hasStarted = true;
        TurretSubsystem.INSTANCE.setToFollow(true);

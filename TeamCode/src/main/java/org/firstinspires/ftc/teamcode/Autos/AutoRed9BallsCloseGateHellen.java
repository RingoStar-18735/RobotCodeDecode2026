...
@Autonomous
public class AutoRed9BallsCloseGateHellen extends NextFTCOpMode {
    ...
    public AutoRed9BallsCloseGateHellen(){
...
//            ShooterSubsystem.INSTANCE.StopSpeed()
    ...
    public void onInit() {
        ...
        Path3 = follower.pathBuilder().addPath(
                        new BezierCurve(
                                new Pose(83.170, 82.587),
                                new Pose(118.146, 81.387),
                                new Pose(144.000, 87.000),
                                new Pose(134.609, 77.275),
                                new Pose(98.407, 81.082),
                                new Pose(126.174, 74.659)
                        )
                )
                .setConstantHeadingInterpolation(Math.toRadians(0))
        ...
        Path5 = follower.pathBuilder().addPath(
                        new BezierCurve(
                                new Pose(77.921, 80.927),
                                new Pose(124.065, 42.758),
                                new Pose(140.179, 59.817),
                                new Pose(113.923, 66.583),
                                new Pose(126.227, 74.714)
                        )
                )
                .setConstantHeadingInterpolation(Math.toRadians(0))
